...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header("Location: ../../Admin/admin_list/manage_users.php?success=Account Created Successfully"); // Redirect to login page
        exit();
    } else {
        header("Location: ../../Admin/admin_operations/add_new_user.php?error=Email Already Exist"); // Redirect to signup page
    }
